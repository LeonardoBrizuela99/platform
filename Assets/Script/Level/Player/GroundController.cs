...
public class GroundController : MonoBehaviour
{
    ...
    private void Update()
    {
       ...
       bool isGroundBelow = Physics.SphereCast(sphereCastOrigin, sphereCastRadius, Vector3.down,out RaycastHit hitInfo,1000,_groundLayerMask,QueryTriggerInteraction.Ignore);
